...
1. Label the points: $(x_1,\ y_1) = (2,\ 3)$ and $(x_2,\ y_2) = (6,\ 11)$.
2. Write the formula: $m = \dfrac{y_2 - y_1}{x_2 - x_1}$.
3. Substitute, keeping both subtractions in the same order: $m = \dfrac{11 - 3}{6 - 2}$.
4. Simplify the top and the bottom: $m = \dfrac{8}{4}$.
5. Reduce: $m = 2$.
